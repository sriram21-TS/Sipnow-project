...
// Shared layout for the Zero % Alcohol section. The section-root page and
// every dedicated subcategory page (wine.jsx, beer.jsx, ...) render this
// with a fixed `subcategory`; a bare /zero-alcohol/:subcategory URL still
